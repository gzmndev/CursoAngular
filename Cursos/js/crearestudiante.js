var registroestudiante =  document.getElementById('registroestudiante');
var url = "https://paginas-web-cr.com/ApiPHP/apis/";
var insertar = "InsertarEstudiantes.php";


registroestudiante.addEventListener('submit', function(e){
    e.preventDefault();
